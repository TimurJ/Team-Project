 ...
 * @author najam
 */
// view of all the jobs that have been created
public class ReceptionistJobManagerForm extends javax.swing.JFrame {
...
ResultSet rs = null;
     ...
     */
    public ReceptionistJobManagerForm() {
        initComponents();
        JobTable();
        showDate();
        showTime();
    ...
    private void initComponents() {
        ...
        btn_current_jobs.setText("Search Customer");
        ...
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addComponent(btn_current_jobs, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_current_jobsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_current_jobsActionPerformed
        ...
        SearchCustomerForm cjmf = new SearchCustomerForm();
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        try
        {
            ...
            // execute query
            rs = pst.executeQuery();
            // set model to data set by query
            table_job.setModel(DbUtils.resultSetToTableModel(rs));
        }
        catch(Exception e)
        {
    ...
    private void btn_refreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_refreshActionPerformed
        // TODO add your handling code here:
        JobTable(); // display jobs based on query from job table method
        txt_search.setText(""); // empty search text field
    ...
    private void PriorityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PriorityActionPerformed
        try
        {
            ...
            if (Priority.isSelected()) {
                ...
                // if not checked, jobtable() method is called
                JobTable();
            }
        }
        catch(Exception e)
    ...
    private void DeadlineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeadlineActionPerformed
        ...
        try
        {
            ...
            if (Deadline.isSelected()) {
                ...
                conn = MysqlConnect.ConnectDB();
                // filter table based on deadline in ascending order
                pst =conn.prepareStatement("SELECT job_id AS ID, deadline, complete, priority, quantity, job_description AS 'job description', special_instructions AS 'special instructions', time_completed AS 'time completed', "
                    + "time_created AS 'time created' "
                    + "FROM job "
    ...
    private void CompletedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CompletedActionPerformed
        ...
        try
        {
            ...
            if (Completed.isSelected()) {
                ...
                conn = MysqlConnect.ConnectDB();
                // dispaly jobs that are completed
                pst =conn.prepareStatement("SELECT job_id AS ID, deadline, complete, priority, quantity, job_description AS 'job description', special_instructions AS 'special instructions', time_completed AS 'time completed', "
                    + "time_created AS 'time created' "
                    + "FROM job "
                        + "WHERE complete = 1");
    ...
    private void btn_tasksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tasksActionPerformed
        ReceptionistCurrentTaskForm ch = new ReceptionistCurrentTaskForm();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceptionistJobManagerForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReceptionistJobManagerForm().setVisible(true);
            }
        });
    }
