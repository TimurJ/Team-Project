 ...
 * @author najam
 */
// display customers and allow ability to search for specific customers
// similar functionality and comments as other search customer forms
public class SearchCustomerShiftForm extends javax.swing.JFrame {
...
ResultSet rs = null;
     ...
     */
    public SearchCustomerShiftForm() {
        initComponents();
        CustomerTable();
        showDate();
        showTime();
    ...
    private void btn_createJobActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_createJobActionPerformed
        CreateJobShift ch = new CreateJobShift();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchCustomerShiftForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchCustomerShiftForm().setVisible(true);
            }
        });
    }
