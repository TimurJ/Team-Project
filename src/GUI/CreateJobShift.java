...
// similar code structure (see createjob and createjoboffice)
public class CreateJobShift extends javax.swing.JFrame {
...
ResultSet rs = null;
    ...
    private void btn_createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_createActionPerformed
        ...
        try {
            ...
            CurrentJobShiftManagerForm ch = new CurrentJobShiftManagerForm();
            ch.setVisible(true);
            this.dispose();
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateJobShift.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateJobShift().setVisible(true);
            }
        });
    }
