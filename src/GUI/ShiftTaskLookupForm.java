 ...
 * @author najam
 */
// select task to add to assigned job
public class ShiftTaskLookupForm extends javax.swing.JFrame {
...
ResultSet rs = null;
    ...
    public void TaskTable() {
        try
        {
            ...
            // display tasks available to set to the assigned job
    ...
    private void btn_addtaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addtaskActionPerformed
        ...
        // insert start time to job task that matches job id =, also inserting value of task id of which was selected
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        {
            conn = MysqlConnect.ConnectDB();
            // display list of tasks where task id matches the value of the text field
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShiftTaskLookupForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShiftTaskLookupForm().setVisible(true);
            }
        });
    }
