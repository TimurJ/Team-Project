 ...
 * @author najam
 */
// upgrade a non valued customer
public class UpgradeCustomerForm extends javax.swing.JFrame {
...
ResultSet rs = null;
    ...
    public void CustomerTable() {
        try
        {
            ...
            // display customers that will be upgraded 
    ...
    private void initComponents() {
        ...
        btn_upgrade.setText("Upgrade Selected Customer");
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        {
            conn = MysqlConnect.ConnectDB();
            // display customers where their customer id matches the value of the text field
            pst =conn.prepareStatement("SELECT customer_id AS ID, name, email, address, contact_number AS 'contact number', contact_person AS 'contact person' "
                    + "FROM customer "
    ...
    private void btn_upgradeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_upgradeActionPerformed
        UpgradeSelectedCustomerForm usc = new UpgradeSelectedCustomerForm();
        ...
        usc.pack();
        this.dispose();
        // pass values within name and custoemr id text field to the next form where they will be assigned a discount
        usc.txt_name.setText(name);
        usc.txt_customerID.setText(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpgradeCustomerForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpgradeCustomerForm().setVisible(true);
            }
        });
    }
