 ...
 * @author najam
 */
// ability to add task to assigned job
public class TaskLookupForm extends javax.swing.JFrame {
...
ResultSet rs = null;
    ...
    private void btn_addtaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addtaskActionPerformed
        TechnicianCurrentJobManagerForm ch = new TechnicianCurrentJobManagerForm();
        
        int row = table_task.getSelectedRow();
        DefaultTableModel model = (DefaultTableModel)table_task.getModel();
        LocalDateTime local = LocalDateTime.now();
        String selected = model.getValueAt(row, 0).toString();
        // insert start time to job task where job id (foreign key refernce) matches value of text field, insert task id (foreign key reference) linked to job task
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        {
            conn = MysqlConnect.ConnectDB();
            // display list of tasks where task id matches the value of text field
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaskLookupForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TaskLookupForm().setVisible(true);
            }
        });
    }
