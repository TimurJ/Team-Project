 ...
 * @author najam
 */
// display tasks that receptionist can add to assigned job
public class ReceptionistTaskLookupForm extends javax.swing.JFrame {
...
ResultSet rs = null;
     ...
     */
    public ReceptionistTaskLookupForm() {
        initComponents();
        TaskTable();
        showDate();
        showTime();
    ...
    public void TaskTable() {
        try
        {
            ...
            // dispaly list of tasks available
    ...
    private void btn_refreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_refreshActionPerformed
        TaskTable(); // display list set by query in this method
        txt_search.setText(""); // set text field to empty
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        {
            conn = MysqlConnect.ConnectDB();
            // display task where the task id matches the value of text field
            pst =conn.prepareStatement("Select * from Task where task_id = '"+txt_search.getText()+"'");
            rs = pst.executeQuery();
            table_task.setModel(DbUtils.resultSetToTableModel(rs));       
            // if text field is empty display list set by query in taskTable method
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceptionistTaskLookupForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReceptionistTaskLookupForm().setVisible(true);
            }
        });
    }
